...
/** CPF com 11 dígitos (apenas números), dígitos verificadores válidos. */
...
/** CNPJ com 14 dígitos (apenas números), dígitos verificadores válidos. */
...
/** Mensagem de erro ou `null` se CPF (11) ou CNPJ (14) for válido. */
...
/** Mensagem de erro ou `null` se CPF (11 dígitos) for válido. */
